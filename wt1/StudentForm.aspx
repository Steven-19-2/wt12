<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentForm.aspx.cs" Inherits="wt1.StudentForm" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td class="auto-style2"><asp:Button ID="subject" Text="User details" runat="server" OnClick="sb" /> </td>
        ...
        <div>
            <table>
                <tr>
                    <td> <asp:Label ID="carIDLabel" runat="server" Text="Car ID"> </asp:Label></td>
                    <td> <asp:TextBox ID="carID" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td> <asp:Label ID="makeLabel" runat="server" Text="Make"> </asp:Label></td>
                    <td> <asp:TextBox ID="make" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
